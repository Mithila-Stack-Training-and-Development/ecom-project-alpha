...
function MiniCart() {
  ...
  if (!isVisible) return null; // user closed it
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg font-semibold mb-2 mt-2 pr-4">
        {t("your_cart")}
      </h3>
      ...
      {cart.length === 0 ? (
        ...
        <>
          ...
          <Link
            to="/cart"
            className="block mt-2 bg-primary text-white py-2 text-center rounded hover:bg-blue-700"
          >
            {t("view_cart")}
          </Link>
        </>
