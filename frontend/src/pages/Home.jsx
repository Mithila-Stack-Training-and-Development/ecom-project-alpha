...
function Home() {
  ...
  const { addToCart, addToWishlist, wishlist = [] } = useStore(); // Default to empty array if undefined
          ...
          return (
            ...
            >
              <Link to={`/product/${product._id || product.id}`}>
                <img
                  src={`http://localhost:5000${product.image}`} // Adjusted for backend URL
                  alt={product.name}
                ...
                <div className="flex space-x-2 mt-2">
                  ...
                  <button
                    onClick={() => {
                      ...
                      toast.success(
                        `${product.name} ${t(
                          isInWishlist ? "removed_from_wishlist" : "added_to_wishlist"
                        )}`
                      );
                    }}
      ...
      >
        {quickViewProduct && (
          ...
          >
            ...
            <img
              src={`http://localhost:5000${quickViewProduct.image}`} // Adjusted for backend URL
