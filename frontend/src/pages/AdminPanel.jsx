  ...
  return (
    <div
      className={`min-h-screen py-10 ${
        theme === "dark" ? "bg-white text-white" : "bg-gray-100 text-gray-900"
      }`}
    >
      <div className="container mx-auto">
        ...
        <form
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white dark:bg-white p-6 rounded shadow mb-10"
        >
          {[
            ...
            <div key={f.n} className="flex flex-col">
              ...
              {f.t === "textarea" ? (
                ...
                <input
                  ...
                  min={f.min}
                  max={f.max}
                  className="border rounded p-2 dark:bg-white"
                />
              )}
            </div>
          ))}
        ...
        <div className="overflow-x-auto bg-white dark:bg-white rounded shadow">
          <table className="min-w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-white">
            ...
            <tbody>
              {products.map((p) => (
                <tr key={p._id} className="border-b border-gray-100 dark:border-white">
                  <td className="p-2">
                    <img
