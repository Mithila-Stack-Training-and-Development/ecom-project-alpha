...
<button type="button" onClick={handleGoogleLogin} className="w-full mt-2 bg-gray-800 text-white py-2 rounded hover:bg-gray-900">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
          {/* About Us */}
          <div>
            <h3 className="text-xl font-bold mb-4">About ShopEase</h3>
            <p className="text-sm">
              ShopEase is your one-stop shop for the latest electronics, fashion, and more. With millions of products and fast shipping, we strive to make every purchase a delight. Join our community today!
            </p>
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              ...
              <li><a href="/home" className="hover:underline">Home & Garden</a></li>
          ...
          {/* Help & Policies */}
          <div>
            <h3 className="text-xl font-bold mb-4">Help & Policies</h3>
            <ul className="text-sm space-y-2">
              <li><a href="/help" className="hover:underline">Customer Support</a></li>
              <li><a href="/returns" className="hover:underline">Returns & Refunds</a></li>
              <li><a href="/shipping" className="hover:underline">Shipping Rates</a></li>
          ...
          <div>
            ...
            <p className="text-sm mb-2">Sign up for exclusive offers!</p>
            <input
              type="email"
        ...
        <div className="container mx-auto mt-8 border-t border-gray-700 pt-6 text-center text-sm">
          <div className="flex justify-center space-x-4 mb-4">
            ...
            <i className="fas fa-shield-alt"></i> 100% Secure Checkout
            <i className="fas fa-sync-alt"></i> Easy Returns
          </div>
          <div className="flex justify-center space-x-4 mb-4">
          ...
          <p>© 2025 ShopEase. All rights reserved. | <a href="/terms" className="hover:underline">Terms</a> | <a href="/privacy" className="hover:underline">Privacy</a></p>
          <p className="mt-2">
            <a href="#" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="hover:underline">
              Back to Top
            </a>
          </p>
        </div>
